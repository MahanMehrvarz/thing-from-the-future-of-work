                    ...
                    <div className="card-inner">
                        <div className="card-face card-front-default" style={style}>
                            ...
                            <div className="card-footer">
                                ...
                                <div className="card-category-small" style={{ marginTop: '4px', color: 'white', fontStyle: 'italic', fontSize: '0.8rem' }}>
                                    <span style={{ marginRight: '5px' }}>AI Futures</span>
                                    <span>Lab</span>
                                </div>
                            </div>
                        </div>
            ...
            <div className="card-container master-card" onClick={handleClick}>
                <div className="card-inner">
                    <div className="card-face" style={{
                        ...
                        <div style={{ color: 'white', fontSize: '1.5rem', fontWeight: '900', textTransform: 'uppercase', textAlign: 'center', lineHeight: '1.1', letterSpacing: '0.05em' }}>
                            {category}<br /><span style={{ fontSize: '1.2rem', fontWeight: '700' }}>MASTER</span>
                        </div>
